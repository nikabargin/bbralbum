...
var Lightbox0 = new SimpleLightbox('.leather-back__link', {loop: false});
var Lightbox1 = new SimpleLightbox('#gallery__nav-all .gallery__img a:first-child');
var Lightbox2 = new SimpleLightbox('#gallery__nav-leather .gallery__img a:first-child');
var Lightbox3 = new SimpleLightbox('#gallery__nav-shoes .gallery__img a:first-child');
var Lightbox4 = new SimpleLightbox('#gallery__nav-bags .gallery__img a:first-child');
var Lightbox5 = new SimpleLightbox('#gallery__nav-other .gallery__img a:first-child');
